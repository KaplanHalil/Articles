...
\paragraph{Future Work.} Future directions include extending the model to support dynamic peer lists and election logic, and combining symbolic verification with computational proofs.