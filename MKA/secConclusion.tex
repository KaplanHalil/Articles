...
\begin{itemize}
  \item \textbf{Agreement }: the Key Server cannot complete a session with parameters it did not initiate, and the Server must have participated for the session to complete.
