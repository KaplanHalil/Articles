...
\begin{itemize}[leftmargin=*,itemsep=0.3em]
  \item \textbf{Executable lemma.} \texttt{exists-trace;} Ex \texttt{mn_ks1 mn_s1 kn sak1 mn_ks2 mn_s2 kn1 sak2 \#i \#j.} \texttt{InitialSessionCompleted(...)@i} \& \texttt{RekeySessionCompleted(...)@j}.
  ...
  \item \textbf{Initial agreement.} \texttt{All mn_ks1 mn_s1 kn sak1 \#i. InitialSessionCompleted(...)@i ==> (Ex \#j. SentInitialSAK(...)@j \& j < i).}
